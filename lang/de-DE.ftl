...
button-nav-backup = Sicherungen
button-nav-restore = Wiederherstellung
button-nav-custom-games = Eigene Spiele
button-nav-other = Einstellungen
...
field-locations = Speicherorte
label-locations-differ = Sicherungen werden in den ersten Ordner geschrieben, die Wiederherstellungsseite liest aber den zweiten. Setze beide auf denselben Ordner, sofern du sie nicht absichtlich getrennt hältst.
check-download-covers = Fehlende Titelbilder herunterladen
label-cover-databases = Optional: Schlüssel für Cover-Datenbanken, die auch Spiele abdecken, die es nicht bei Steam gibt. SteamGridDB vergibt kostenlose Schlüssel; IGDB nutzt eine Twitch-Client-ID samt Secret.
field-steamgriddb-key = SteamGridDB-Schlüssel:
